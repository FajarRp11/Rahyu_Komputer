...
$cekTotalPenjualan = mysqli_query($koneksi, "SELECT COUNT(*) AS total FROM tabel_header_transaksi");
$rowTotalPenjualan = mysqli_fetch_assoc($cekTotalPenjualan);
$totalPenjualan = $rowTotalPenjualan['total'];
            ...
            <div class="card h-100">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-uppercase mb-1">Total Penjualan
                            </div>
